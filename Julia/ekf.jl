...
#date of completion: 04/18/25
#description: extended kalman filter for fault classification through the variance of the residual

include("bifurcation.jl") #have old bifurcation file for certain calculations
using HypothesisTests, Plots, StatsBase #run your variance tests
using LinearAlgebra #for matrix and other numerical operations
